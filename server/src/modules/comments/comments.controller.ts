...
export class CommentsController {
	...
	@ApiOperation({
		summary: '구매리뷰 추가',
		description: '구매한 상품에 대한 구매후기 추가 요청',
	})
	...
	// @UseGuards(JwtAuthGuard)
	@ApiOperation({
		summary: '구매후기 리스트/구매자 정보창 기준',
		description: '구매한 상품에 대한후기 리스트 요청',
	})
	@ApiCreatedResponse({ description: 'successful' })
	...
	@ApiOperation({
		summary: '구매리뷰 수정',
		description: '구매한 상품에 대한 구매후기 수정 요청',
	})
	@ApiCreatedResponse({ description: 'successful' })
	...
	@ApiOperation({
		summary: '구매 리뷰 삭제',
		description: 'item_review 삭제 요청을 받습니다.',
	})
  ...
  // @UseGuards(JwtAuthGuard)
  @ApiOperation({ summary: '개발용 item_review 입력 기능', description: '개발 단계에서 테스트를 위한 재고 입력' })
  @ApiCreatedResponse({ description: 'successful' })
  reviewManagement(@Body() data: ReviewManagement) {
    return this.commentsService.reviewManagement(data)
  }
}
